...
export const tracks: Track[] = [
  ...
  { id: "t8", title: "Anoint Me (w/ BGVs)", artist: "Georlynn & First Love Music", duration: "7:49", plays: 1000, size: "10.8 MB", category: "worship", imageUrl: `${UPL}/2024/08/Anoint-Me.jpg`, mood: "anointing", trending: true, coverColor: "#7b1fa2", coverColor2: "#6a1b9a", coverImage: `${UPL}/2024/08/Anoint-Me.jpg`, stationUrl: `${BASE}/station/anoint-me/`, downloadUrl: `${UPL}/2022/07/Anoint-Me-Official-Instrumental.mp3` },
  ...
  { id: "t11", title: "Go Somewhere 04", artist: "First Love Music & Aida", duration: "6:20", plays: 268, size: "8.7 MB", category: "worship", imageUrl: `${UPL}/2024/08/Artboard-17-3.png`, mood: "dancing", trending: true, coverColor: "#00838f", coverColor2: "#006064", coverImage: `${UPL}/2024/08/Artboard-17-3.png`, stationUrl: `${BASE}/station/go-somewhere-04/`, downloadUrl: `${UPL}/2024/04/Go-Somewhere-04.mp3` },
  ...
  { id: "n1", title: "Jesus Savoiur Of The World 142", artist: "First Love Music & Aida", duration: "6:42", plays: 4800, size: "6.2 MB", category: "worship", imageUrl: "", mood: "honour", trending: true, coverColor: "#e65100", coverColor2: "#bf360c", stationUrl: `${BASE}/station/jesus-savoiur-of-the-world-142/`, downloadUrl: `${UPL}/2024/04/Jesus-Savoiur-Of-The-World-142-1.mp3` },
  { id: "n2", title: "I See You Jesus 206", artist: "Aseda", duration: "5:00", plays: 850, size: "4.7 MB", category: "worship", imageUrl: "", mood: "honour", coverColor: "#283593", coverColor2: "#1a237e", stationUrl: `${BASE}/station/i-see-you-jesus-206/`, downloadUrl: `${UPL}/2024/03/I-See-You-Jesus-206.mp3` },
  { id: "n3", title: "I Cannot Love You More Than I Love God 134", artist: "First Love Music & Aida", duration: "7:43", plays: 1200, size: "7.1 MB", category: "worship", imageUrl: "", mood: "love", coverColor: "#c62828", coverColor2: "#b71c1c", stationUrl: `${BASE}/station/i-cannot-love-you-more-than-i-love-god-134/`, downloadUrl: `${UPL}/2024/04/I-Cannot-Love-You-More-Than-I-Love-God-134.mp3` },
  { id: "n4", title: "My Beloved Is Mine 52", artist: "First Love Music & Aida", duration: "7:40", plays: 900, size: "7.1 MB", category: "worship", imageUrl: "", mood: "beloved", coverColor: "#ad1457", coverColor2: "#880e4f", stationUrl: `${BASE}/station/my-beloved-is-mine-52-2/`, downloadUrl: `${UPL}/2024/04/My-Beloved-Is-Mine-52-2.mp3` },
  { id: "n5", title: "Fallin' In Love With You Again", artist: "Phil Driscoll", duration: "7:17", plays: 121, size: "6.7 MB", category: "worship", imageUrl: "", mood: "beloved", coverColor: "#4527a0", coverColor2: "#311b92", stationUrl: `${BASE}/station/fallin-in-love-with-you-again/`, downloadUrl: `${UPL}/2024/03/Fallin-In-Love-With-You-Again-1.mp3` },
  { id: "n6", title: "A Lovely Diamond 212", artist: "First Love Music & Keziah", duration: "5:49", plays: 246, size: "5.4 MB", category: "worship", imageUrl: "", mood: "beloved", coverColor: "#f9a825", coverColor2: "#f57f17", stationUrl: `${BASE}/station/a-lovely-diamond-212/`, downloadUrl: `${UPL}/2024/05/A-Lovely-Diamond-212.mp3` },
  { id: "n7", title: "Why Did I Come Into The World 82", artist: "First Love Music", duration: "9:19", plays: 650, size: "8.6 MB", category: "worship", imageUrl: "", mood: "anointing", coverColor: "#7b1fa2", coverColor2: "#6a1b9a", stationUrl: `${BASE}/station/why-did-i-come-into-the-world-82/`, downloadUrl: `${UPL}/2024/05/Why-Did-I-Come-Into-The-World-82.mp3` },
  { id: "n8", title: "Sweet Mama, Poor Lover 139", artist: "Aida & First Love Music", duration: "6:55", plays: 780, size: "6.4 MB", category: "worship", imageUrl: "", mood: "relationships", coverColor: "#c62828", coverColor2: "#b71c1c", stationUrl: `${BASE}/station/sweet-mama-poor-lover-139/`, downloadUrl: `${UPL}/2024/05/Sweet-Mama-Poor-Lover-139.mp3` },
  { id: "n9", title: "Jesus What A Wonder You Are", artist: "Maranatha Music", duration: "4:02", plays: 560, size: "3.7 MB", category: "worship", imageUrl: "", mood: "honour", coverColor: "#1565c0", coverColor2: "#0d47a1", stationUrl: `${BASE}/station/jesus-what-a-wonder-you-are/`, downloadUrl: `${UPL}/2024/08/jesus-what-a-wonder-you-are.mp3` },
  { id: "n10", title: "Lord Make Me Pure In Heart", artist: "Lenny LeBlanc", duration: "2:46", plays: 340, size: "2.6 MB", category: "worship", imageUrl: "", mood: "prayer", coverColor: "#0277bd", coverColor2: "#01579b", stationUrl: `${BASE}/station/lord-make-me-pure-in-heart/`, downloadUrl: `${UPL}/2024/08/lord-make-me-pure-in-heart.mp3` },
  { id: "n11", title: "Abide In Me", artist: "Sandra Crouch", duration: "5:00", plays: 189, size: "4.7 MB", category: "worship", imageUrl: "", mood: "prayer", coverColor: "#37474f", coverColor2: "#263238", stationUrl: `${BASE}/station/abide-in-me/`, downloadUrl: `${UPL}/2025/11/Sandra-Crouch-Abide-In-Me-Full-Instrumental.m4a` },
  { id: "n12", title: "All Around", artist: "Israel Houghton", duration: "4:38", plays: 431, size: "4.3 MB", category: "worship", imageUrl: "", mood: "honour", coverColor: "#2e7d32", coverColor2: "#1b5e20", stationUrl: `${BASE}/station/all-around/`, downloadUrl: `${UPL}/2025/11/Israel-Houghton-All-Around.mp3` },
  { id: "n13", title: "Jesus, Your Name Is Power", artist: "Maranatha Music", duration: "3:26", plays: 328, size: "3.2 MB", category: "worship", imageUrl: "", mood: "honour", coverColor: "#e65100", coverColor2: "#bf360c", stationUrl: `${BASE}/station/jesus-your-name-is-power/`, downloadUrl: `${UPL}/2025/11/ShemenMUSIC-Maranatha-Music-Jesus-Your-Name-Is-Power.mp3` },
];
...
export const moods: Mood[] = [
  ...
  { id: "hope", label: "Hope", emoji: "🌅", color: "#e65100" },
  { id: "love", label: "Love", emoji: "❤️", color: "#c62828" },
  { id: "praise", label: "Praise", emoji: "🙌", color: "#f9a825" },
  { id: "prayer", label: "Prayer", emoji: "🤲", color: "#1565c0" },
  { id: "relationships", label: "Relationships", emoji: "🫶", color: "#ad1457" },
  { id: "spirituality", label: "Spirituality", emoji: "✨", color: "#4527a0" },
  { id: "thankfulness", label: "Thankfulness", emoji: "🙏", color: "#2e7d32" },
  { id: "the-church", label: "The Church", emoji: "⛪", color: "#37474f" },
];
